...
public class MyMain extends Game {
	...
	public static float mouseX[] = new float[5];
	public static float mouseY[] = new float[5];
	
	@Override
	public void create () {
		batch = new SpriteBatch();
		cam = new OrthographicCamera(1200, 700);
	...
	public void updateMouse() {
		for(int i=0; i<5; i++) {
			if(Gdx.input.isTouched(i)) {
				MyMain.mouseX[i] = Gdx.input.getX(i)*1200/MyMain.width;
				MyMain.mouseY[i] = (MyMain.height-Gdx.input.getY(i))*700/MyMain.height;
			}
		}
	}
}
