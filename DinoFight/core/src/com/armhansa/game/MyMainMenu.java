...
public class MyMainMenu implements Screen {
    ...
    public MyMainMenu(MyMain main) {
    	...
    	Preferences myPref = Gdx.app.getPreferences("PlantPlants");
    	name = myPref.getString("Name", null);
    	if(name != null) {
    		money = myPref.getInteger("Money");
    		for(int i=0; i<4; i++) seeds[i] = myPref.getInteger("Seed"+i);
	...
	public void render(float delta) {
        ...
        if(newGameBtn.overlaps(new Rectangle(MyMain.mouseX[0], MyMain.mouseY[0], 0.5f, 0.5f))) {
        ...
        if(canLoad && loadGameBtn.overlaps(new Rectangle(MyMain.mouseX[0], MyMain.mouseY[0], 0.5f, 0.5f))) {
        ...
        if(exitGameBtn.overlaps(new Rectangle(MyMain.mouseX[0], MyMain.mouseY[0], 0.5f, 0.5f))) {
