...
//	boolean touchedClose = false;
	...
	public void checkAction() {
		if(noBuy.overlaps(new Circle(MyMain.mouseX[0], MyMain.mouseY[0], 0.5f))) {
			touchedNo = true;
		...
		if(yesBuy.overlaps(new Circle(MyMain.mouseX[0], MyMain.mouseY[0], 0.5f))) {
			touchedYes = true;
			if(Gdx.input.justTouched()) {
		...
		if(addOrder.overlaps(new Circle(MyMain.mouseX[0], MyMain.mouseY[0], 0.5f))) {
			touchedAdd = true;
			if(Gdx.input.justTouched()) {
		...
		if(reduceOrder.overlaps(new Circle(MyMain.mouseX[0], MyMain.mouseY[0], 0.5f))) {
			touchedReduce = true;
			if(Gdx.input.justTouched()) {
